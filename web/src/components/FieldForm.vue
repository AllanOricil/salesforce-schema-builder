  ...
  <form class="mx-2 mb-5" ref="fieldForm">
    <div class="form-row">
      ...
      <div
        ...
        class="form-group col-12"
      >
        <label for="fieldRelationshipName">Child Relationship Name</label>
        <input
          type="text"
          class="form-control"
      ...
      <div v-if="field.type === 'AutoNumber'" class="form-group col-12">
        ...
        <input
          ...
          @keyup="checkValidity"
        />
        <small id="fieldDisplayFormatHelp" class="form-text text-muted">A-{0000}</small>
      </div>
      <div v-if="field.type === 'AutoNumber'" class="form-group col-12">
      ...
      <div v-if="field.type === 'Location'" class="form-group col-12">
        <label for="fieldDisplayLocationInDecimal">Latitude and Longitude Display Notation</label>
        <select
          class="form-control"
      ...
      >
        ...
        >
          ...
          <option value="2">Enter values, with each value separated by a new line</option>
        </select>
      </div>
      <div
        v-if="
      ...
      >
        <textarea
          ...
          @keyup="checkValidity"
        ></textarea>
        <small class="form-text text-muted">Enter values, with each value separated by a new line</small>
      </div>
      <div
        v-if="
                    (field.type === 'MultiselectPicklist' ||
      ...
      <div
        ...
        class="form-group col-12"
      >
        <label class="form-check-label custom-checkbox-container" for="fieldValueSetRestricted">
      ...
      <div
        ...
        class="form-group col-12"
      >
        <label class="form-check-label custom-checkbox-container" for="fieldRequired">
          Required
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div
        ...
        class="form-group col-12"
      >
        <label class="form-check-label custom-checkbox-container" for="fieldUnique">
          Unique
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div v-if="field.type === 'Text' && field.unique" class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="fieldCaseSensitive">
          Case Sensitive ?
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div
        ...
        class="form-group col-12"
      >
        <label class="form-check-label custom-checkbox-container" for="fieldExternalId">
          External Id
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div v-if="field.type === 'EncryptedText'" class="form-group col-12">
      ...
      <div v-if="field.type === 'Formula'" class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="fieldTreatBlanksAs">
      ...
      <div v-if="field.type === 'Lookup'" class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="fieldDeleteConstraint">
...
export default {
    ...
    computed: {
        standardObjects() {
            return Object.values(this.$store.state.sobjects.sobjects).filter((object) => {
                return !(
        ...
        changeEventObjets() {
            return Object.values(this.$store.state.sobjects.sobjects).filter((object) =>
                /^\w*ChangeEvent\b$/g.test(object.name)
            );
        },
        historyObjects() {
            return Object.values(this.$store.state.sobjects.sobjects).filter((object) =>
                /^\w*History\b$/.test(object.name)
            );
        },
        customObjects() {
            return Object.values(this.$store.state.sobjects.sobjects).filter((object) =>
        ...
        orderedGlobalValueSets() {
            return Object.values(this.$store.state.globalvaluesets.globalValueSets).sort(function (a, b) {
                return a.fullName
                    .toLowerCase()
