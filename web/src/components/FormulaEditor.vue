  ...
  <div>
    ...
    <div class="d-flex flex-column flex-xl-row">
      <div class="form-group col-12 col-xl-6 mb-2 pr-0 pr-xl-4">
        ...
        <div class="d-flex">
          <div class="d-flex mb-0 pl-0 pr-1 flex-grow-1">
            <select class="form-control" id="formulaFunctions" v-model="formulaType">
              <option value="ABS(number)" selected>ABS</option>
              <option value="ADDMONTHS(date,num)">ADDMONTHS</option>
              <option value="AND(logical1,logical2,...)">AND</option>
              <option value="BEGINS(text, compare_text)">BEGINS</option>
              <option value="BLANKVALUE(expression, substitute_expression)">BLANKVALUE</option>
              ...
              <option value="CONTAINS(text, compare_text)">CONTAINS</option>
              <option value="CURRENCYRATE(IsoCode)">CURRENCYRATE</option>
              <option value="DATE(year,month,day)">DATE</option>
              <option value="DATETIMEVALUE(expression)">DATETIMEVALUE</option>
              <option value="DATEVALUE(expression)">DATEVALUE</option>
              <option value="DAY(date)">DAY</option>
              <option value="DISTANCE(location, location, unit)">DISTANCE</option>
              <option value="EXP(number)">EXP</option>
              <option value="FIND(search_text, text [, start_num])">FIND</option>
              <option value="FLOOR(number)">FLOOR</option>
              <option value="GEOLOCATION(latitude, longitude)">GEOLOCATION</option>
              <option value="GETSESSIONID()">GETSESSIONID</option>
              <option value="HOUR(expression)">HOUR</option>
              <option value="HYPERLINK(url, friendly_name [, target])">HYPERLINK</option>
              <option value="IF(logical_test, value_if_true, value_if_false)">IF</option>
              <option value="IMAGE(image_url, alternate_text [, height, width])">IMAGE</option>
              <option value="INCLUDES(multiselect_picklist_field, text_literal)">INCLUDES</option>
              ...
              <option value="ISPICKVAL(picklist_field, text_literal)">ISPICKVAL</option>
              ...
              <option value="LPAD(text, padded_length [, pad_string])">LPAD</option>
              ...
              <option value="MID(text, start_num, num_chars)">MID</option>
              <option value="MILLISECOND(expression)">MILLISECOND</option>
              ...
              <option value="NULLVALUE(expression, substitute_expression)">NULLVALUE</option>
              <option value="OR(logical1,logical2,...)">OR</option>
              <option value="RIGHT(text, num_chars)">RIGHT</option>
              <option value="ROUND(number,num_digits)">ROUND</option>
              <option value="RPAD(text, padded_length [, pad_string])">RPAD</option>
              <option value="SECOND(expression)">SECOND</option>
              <option value="SQRT(number)">SQRT</option>
              <option value="SUBSTITUTE(text, old_text, new_text)">SUBSTITUTE</option>
              <option value="TEXT(value)">TEXT</option>
              <option value="TIMENOW()">TIMENOW</option>
              <option value="TIMEVALUE(expression)">TIMEVALUE</option>
      ...
      <div class="form-group col-12 col-xl-6 mb-2">
        ...
        <div class="d-flex">
          <div class="d-flex mb-0 pl-0 pr-1 flex-grow-1">
            <select class="form-control" id="formulaOperators" v-model="operator">
    ...
    <b-modal id="modal-1" size="xl" title="Insert Field" centered cancel-disabled>
      <div class="container">
        <select
      ...
      <template v-slot:modal-footer="{ close }">
        ...
        >
        <button type="button" class="btn btn-md danger" @click="insertField()">Insert</button>
        >
      </template>
    </b-modal>
  </div>
