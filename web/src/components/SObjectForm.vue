<template>
  <form class="mx-2" id="sObjectForm" ref="sObjectForm">
    <div class="form-row">
      ...
      <div v-if="sobject.dataType === 'AutoNumber'" class="form-group col-12">
        ...
        <input
          ...
          @keyup="checkValidity"
        />
        <small id="passwordHelpBlock" class="form-text text-muted">Example: A-{0000}</small>
      </div>
      <div v-if="sobject.dataType === 'AutoNumber'" class="form-group col-12">
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowReports">
          Allow Reports
          <input
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowActivities">
          Allow Activities
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectTrackFieldHistory">
          Track Field History
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowInChatterGroups">
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowSharing">
          Allow Sharing
          <input
            class="form-check-input"
            type="checkbox"
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowBulkApiAccess">
      ...
      <div class="form-group col-12">
        <label class="form-check-label custom-checkbox-container" for="sObjectAllowSearch">
          Allow Search
          <input
            class="form-check-input"
            type="checkbox"
...
export default {
    ...
    computed: {
        sObjecComputedData() {
            return {
                ...
                allowInChatterGroups: this.sobject
    ...
    watch: {
        'sobject.label'(newValue, oldValue) {
            this.sobject.objectName = this.sobject.label.replace(
                /\s/g,
                '_'
            );
            this.sobject.name = this.sobject.label;
            this.sobject.recordName =
